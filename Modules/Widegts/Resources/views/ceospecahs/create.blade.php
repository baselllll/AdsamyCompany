        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Create New Blog <small>new Blog</small></h2>
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" action="{{ route('ceospecahs.store') }}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text" id="videolink" name="videolink" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
