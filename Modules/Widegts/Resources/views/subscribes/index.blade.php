        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>subscribes Table <small> all subscribes </small></h2>
                                        ...
                                        @foreach($subscribes as $row)
                                            ...
                                            <td class=" ">
                                                <form action="#" method="post">
                                                    <a href="{{ route('subscribes.edit',['id'=>$row->id]) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                                    <a data-id="" href="{{route('subscribes.destroy',['id'=>$row->id]) }}" class="btn btn-danger btn-sm delete_subscribes"><i class="fa fa-trash-o"></i></a>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
