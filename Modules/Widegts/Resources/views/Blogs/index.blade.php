                                ...
                                <table id="myTable" class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        @foreach($Blogs as $row)
                                            ...
                                            <td class=" "><img class="img-thumbnail" width="100px" height="40px" src="/front/images/blogs/{{ $row->img }}"/></td>
                                            <td class=" ">
                                                <form action="#" method="post">
                                                    <a href="{{ route('blog.edit',['id'=>$row->id]) }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                                                    <a data-id="" href="{{route('blog.destroy',['id'=>$row->id]) }}" class="btn btn-danger btn-sm delete_blog"><i class="fa fa-trash-o"></i></a>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
