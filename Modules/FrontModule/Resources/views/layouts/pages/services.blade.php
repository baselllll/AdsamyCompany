...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="info">
                        <div>
                            <h2>امان الويب</h2>
                            <p>لأن الاستضافة عامل مهم جدًا في نجاح واستمرارية الموقع ؛ أنت
                                يجب أن تكون على دراية بنقاط القوة في الاستضافة الخاصة بك من حيث مساحة التخزين وحركة المرور والبرامج النصية
                                تعلق على الاستضافة ، لوحة التحكم ،
                                والأهم من ذلك كله ، الدعم الفني الفوري ، والذي تقدمه ليك
                                بأفضل طريقة وهي ليست بمستوى الأمان العالي للخوادم والعديد من الميزات الأخرى
                                ....</p>
                        </div>
                    </div>
                    @else
    ...
    <section class="counter-section jarallax two">
        <div class="container">
            @if ($lang=="ar")
            <div class="content">
                <h4>احصل على مجال مميز أو استضافة الآن</h4>
                <p>اسأل عن السعر إذا كنت تريد خطة استضافة خاصة غير متوفرة في العروض</p>
                <a href="#" class="main-btn white">اطلب الان</a>
            </div>
            @else
            <div class="content">
                ...
                <div class="col-lg-4 wow fadeInUp">
                    <div class="box_table">
                        <div class="head">
                            ...
                            <div class="text">
                                <span class="title">الخطة الأساسية</span>
                                <span class="price">$199</span>
                            </div>
                        </div>
                        <div class="info">
                            <p>الخطة الاساسية لها معايرها الخاصة</p>
                            <ul>
                                
                            </ul>
                            <a href="#" class="main-btn solid">اختر الخطة<i class="far fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow fadeInUp">
                    <div class="box_table">
                        <div class="head">
                            ...
                            <div class="text">
                                <span class="title">الخطة الاحترافية</span>
                                <span class="price">$299</span>
                            </div>
                        </div>
                        <div class="info">
                            <p>الخطة الاحترافية لها معايرها الخاصة</p>
                            <ul>
                ...
                <div class="col-lg-4 wow fadeInUp">
                    <div class="box_table">
                        <div class="head">
                            ...
                            <div class="text">
                                <span class="title">الخطة المتقدمة</span>
                                <span class="price">$199</span>
                            </div>
                        </div>
                        <div class="info">
                            <p>الخطة المتقدمة لها معايرها الخاصة</p>
                            <ul>
