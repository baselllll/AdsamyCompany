            ...
            <div class="item bg_1">
                ...
                <div class="info">
                    <div class="hidden-box">
                        <h2 class="animate_down">the title to company</h2>
                    </div>
                    <div class="hidden-box">
                        <p class="animate_down">The company seeks to provide all services from designing websites and mobile
                            applications and doing all that is necessaryThe company seeks</p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 wow fadeInLeft">
                    <div class="about-image">
                        <img src="{{ asset('front/assets/img/about_02.png') }}" alt="">
                        <div class="sec-img"><img src="{{ asset('front/assets/img/about_01.png') }}" alt=""></div>
                ...
                <div class="col-lg-6 wow fadeInRight">
                    <div class="about-info">
                        ...
                        <h5>A welcome word that delights <br> the customer when he reads about us</h5>
            ...
            <div class="row wow fadeInUp">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="box">
                        <div class="image">
                            <div class="ratio">
                                <img src="{{ asset('front/assets/img/works/01.jpg') }}" alt="img" class="img-fluid">
                            </div>
                            <a class="venobox vbox-item" data-gall="venue-gallery"
                                href="{{ asset('front/assets/img/works/01.jpg') }}">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="box">
                        <div class="image">
                            <div class="ratio">
                                <img src="{{ asset('front/assets/img/works/02.jpg') }}" alt="img" class="img-fluid">
                            </div>
                            <a class="venobox vbox-item" data-gall="venue-gallery"
                                href="{{ asset('front/assets/img/works/02.jpg') }}">
                                <div class="overlay"><i class="fal fa-plus-circle"></i></div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="box">
                        <div class="image">
                            <div class="ratio">
                                <img src="{{ asset('front/assets/img/works/03.jpg') }}" alt="img" class="img-fluid">
                            </div>
                            <a class="venobox vbox-item" data-gall="venue-gallery"
                                href="{{ asset('front/assets/img/works/03.jpg') }}">
                                <div class="overlay"><i class="fal fa-plus-circle"></i></div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="box">
                        <div class="image">
                            <div class="ratio">
                                <img src="{{ asset('front/assets/img/works/04.jpg') }}" alt="img" class="img-fluid">
                            </div>
                            <a class="venobox vbox-item" data-gall="venue-gallery"
                                href="{{ asset('front/assets/img/works/04.jpg') }}">
                                <div class="overlay"><i class="fal fa-plus-circle"></i></div>
                            </a>
                        </div>
                    </div>
